...
model_info = {
    ...
    "framework": "sklearn",
    "dataset": dataset,
    "config": {"class": "LogisticRegression", "default_params": {"C": 1.0, "max_iter": 1000, "random_state": 42}, "framework": "sklearn", "import": "from sklearn.linear_model import LogisticRegression"}
}
