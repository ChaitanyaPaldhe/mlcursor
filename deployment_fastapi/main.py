...
try:
    ...
    logger.info(f"✅ Model loaded successfully from: logistic_regression_iris.pkl")
except Exception as e:
    logger.error(f"❌ Error loading model from logistic_regression_iris.pkl: {e}")
    raise

# Load encoder
encoder = None
try:
    encoder = joblib.load("logistic_regression_iris_encoders.pkl")
    logger.info(f"✅ Encoder loaded successfully from: logistic_regression_iris_encoders.pkl")
except Exception as e:
    logger.warning(f"⚠️ Could not load encoder from logistic_regression_iris_encoders.pkl: {e}")
    encoder = None

# Load scaler
scaler = None
try:
    scaler = joblib.load("logistic_regression_iris_scaler.pkl")
    logger.info(f"✅ Scaler loaded successfully from: logistic_regression_iris_scaler.pkl")
except Exception as e:
    logger.warning(f"⚠️ Could not load scaler from logistic_regression_iris_scaler.pkl: {e}")
    scaler = None
...
def home():
    ...
    return {
        ...
        "model_path": "logistic_regression_iris.pkl",
        "encoder_available": encoder is not None,
        "scaler_available": scaler is not None,
        "encoder_path": "logistic_regression_iris_encoders.pkl",
        "scaler_path": "logistic_regression_iris_scaler.pkl",
        "status": "healthy",
...
if __name__ == "__main__":
    ...
    print(f"📊 Model: logistic_regression_iris.pkl")
    print(f"🔧 Encoder: logistic_regression_iris_encoders.pkl")
    print(f"📏 Scaler: logistic_regression_iris_scaler.pkl")
