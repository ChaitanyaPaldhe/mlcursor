...
try:
    model = joblib.load(r"G:\Codes\mlcursor\outputs\models\random_forest_penguins.pkl")
    print(f"✅ Model loaded successfully from: outputs\models\random_forest_penguins.pkl")
except Exception as e:
    print(f"❌ Error loading model from outputs\models\random_forest_penguins.pkl: {e}")
    raise
...
def home():
    ...
    return {
        ...
        "model_path": "outputs\models\random_forest_penguins.pkl",
        "status": "healthy",
...
if __name__ == "__main__":
    ...
    print(f"📊 Model: outputs\models\random_forest_penguins.pkl")
